function callGeo(place) {
    $.ajax({
        ...
        url: 'https://maps.googleapis.com/maps/api/geocode/json?address=' + place + '&key=AIzaSyBzXyvFYC2lyvD4-_WiPxOUyh-ZS034JcU',
        method: "GET",
        type: "json"
...
function callWeather(latitude, longitude){
    ...
    url: "https://api.openweathermap.org/data/2.5/forecast/daily?lat=" + latitude + "&lon=" + longitude + "&units=imperial&cnt=" + days + "&appid=12f8d81e8a15508386c17efed1108ee40",
    method: "GET",
    type: "json"
